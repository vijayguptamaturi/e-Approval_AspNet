<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="CEOApproval.aspx.cs" Inherits="eApproval.UserInterface.CEOApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function EmptyControlValidations() {
            ...
            var CEOJustificationDetails = document.getElementById("<%=txtCEOComments.ClientID%>").value;
            if (CEOJustificationDetails == "") {
                alert('Comments is Required..');
                document.getElementById("<%=txtCEOComments.ClientID%>").focus();
                return false;
            }
           
            
            <%--  var ChkCEOApprove = document.getElementById("<%=chkCEOApprove.ClientID%>").value;
           
            if (ChkCEOApprove != 0 || ChkCEOApprove != 1) {
                alert('Please Check the Approve or Disapprove CheckBox..');
                document.getElementById("<%=chkCEOApprove.ClientID%>").focus();
                return false;
            }--%>
            ...
            var CEOCHK = document.getElementById("<%=chkCEOApprove.ClientID%>");
            var CEOcheckbox = CEOCHK.getElementsByTagName("input");
            var counter = 0;
            for (var i = 0; i < CEOcheckbox.length; i++) {
                if (CEOcheckbox[i].checked) {
                    counter++;
                }
            }
            if (atLeast > counter) {
      ...
      <asp:UpdatePanel ID="MainUpdatePannel" runat="server">
        ...
        <asp:GridView ID="grdFileData" runat="server" Width="400px" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="EmptyDataRowStyleGridview" OnRowCreated="grdFileData_RowCreated" EmptyDataText="No Documents Uploaded" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
            ...
            <SortedDescendingHeaderStyle BackColor="#00547E" />
                        ...
                        <tr>
                            ...
                            <td colspan="4" style="padding-left: 610px;">
                             ...
                             <%--   <center><asp:CheckBox ID="chkFinanceApprove"  OnCheckedChanged="chkFinanceApprove_CheckedChanged" runat="server" Text="   Approve" Font-Size="14pt" ForeColor="Black"  Font-Names="Times New Roman" Width="120px"/></center>--%>
                                 ...
                                 <asp:CheckBox  runat="server" Text="   Approve" ID="chkFinanceApprove" Font-Size="14pt" ForeColor="Black"  Font-Names="Times New Roman" Width="120px" AutoPostBack="true" />
                            </td>
                ...
                <asp:Panel ID="pnlCEOApproval"   runat="server" BorderStyle="Groove">
                    ...
                    <table style="margin-left: 130px;">
                        ...
                        <tr>
                            ...
                            <td colspan="4" style="padding-left: 490px;">
                                ...
                                <asp:CheckBoxList runat="server" ID="chkCEOApprove" OnSelectedIndexChanged="chkCEOApprove_SelectedIndexChanged" Font-Size="14pt" ForeColor="Black" Font-Names="Times New Roman" Width="260px" AutoPostBack="True" RepeatDirection="Horizontal">
                            ...
                            <td colspan="2" style="text-align: center; padding-left: 10px;">
                                ...
                                <asp:Image ID="imgCEOSignature" runat="server" Width="200px" Height="50px" />
                                <br />
                            ...
                            <td style="padding-left: 20px;">
                                ...
                                <asp:Button ID="btnCEOSubmit" OnClick="btnCEOSubmit_Click" OnClientClick="return EmptyControlValidations()" runat="server" Text="Submit" CssClass="myButton"></asp:Button>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            ...
                            <td colspan="4" style="padding-left: 490px;">
                                ...
                                <asp:CheckBoxList runat="server" ID="chkMDApprove"  Font-Size="14pt" ForeColor="Black" Font-Names="Times New Roman" Width="260px" AutoPostBack="True" RepeatDirection="Horizontal">
                                    <asp:ListItem Text="Approve" Value="0" onclick="MutExChkList(this);"> </asp:ListItem>
                                    <asp:ListItem Text="DisApprove" Value="1" onclick="MutExChkList(this);"> </asp:ListItem>
