<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ViewApprovals.aspx.cs" Inherits="eApproval.UserInterface.ViewApprovals" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:UpdatePanel ID="MainUpdatePannel" runat="server">
                    ...
                    <table style="margin-left: 10px; padding-top: 0px;">
                        <tr>
                            ...
                            <td style="padding-left: 1160px;">
                                <asp:LinkButton ID="lnkbtnPrint" OnClick="lnkbtnPrint_Click" runat="server" Text="Print SR" Font-Size="13px" ForeColor="White"></asp:LinkButton>
                            </td>
                        </tr>
                    </table>
        ...
        <asp:GridView ID="grdFileData" runat="server" Width="400px" ShowHeaderWhenEmpty="true" EmptyDataRowStyle-CssClass="EmptyDataRowStyleGridview" OnRowCreated="grdUploadData_RowCreated" EmptyDataText="No Documents Uploaded" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
                ...
                <asp:BoundField DataField="FileName" HeaderText="Doc Name" HeaderStyle-Width="300px" >
                 ...
                 <asp:TemplateField HeaderStyle-Width="80px" HeaderText="View" ItemStyle-HorizontalAlign="Center">
                  ...
                  <asp:TemplateField HeaderStyle-Width="80px" HeaderText="Delete" ItemStyle-HorizontalAlign="Center">
                     <ItemTemplate>
                         <asp:ImageButton ID="btnDelete" runat="server" Enabled="false" ToolTip="Delete Access Denied" ImageUrl="~/Images/Delete.png" Width="13px" Height="13px"  CommandName="Delete" />
                     </ItemTemplate>
                 </asp:TemplateField>
            ...
            <SortedDescendingHeaderStyle BackColor="#00547E" />
                ...
                <asp:Panel ID="pnlFinanceRoutingDept"  ToolTip="Access is Disabled" runat="server" BorderStyle="Groove">
                    ...
                    <table style="margin-left: 130px;">
                        ...
                        <tr>
                            ...
                            <td colspan="4" style="padding-left: 620px;">
                ...
                <asp:Panel ID="pnlCEOApproval"  runat="server" BorderStyle="Groove">
                    ...
                    <table style="margin-left: 130px;">
                        ...
                        <tr>
                            ...
                            <td colspan="4" style="padding-left: 500px;">
